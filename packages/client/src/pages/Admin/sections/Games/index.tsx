...
export const Games: React.FunctionComponent<OrdersProps> = ({
  games,
  error,
}) => {
        ...
        <>
          ...
          <table className={styles.itemsTable}>
            <tr className={`${styles.row} ${styles.headerRow}`}>
              ...
              <th className={styles.col}>Number of physical copies</th>
              <th
            ...
            {games
              ...
              .map((game) => (
                <tr className={styles.row} key={game.id}>
                  ...
                  <td className={styles.col}>{game.numberOfPhysicalCopies}</td>
